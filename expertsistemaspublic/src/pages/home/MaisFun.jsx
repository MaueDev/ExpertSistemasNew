            ...
            <div className="inner">
                ...
                <div className="Colum">
                        ...
                        <div className="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            <div className="panel panel-default">
                                <div className="panel-heading" role="tab" id="headingTwo">
                                    <h4 className="panel-title">
                                        <a className="btn-accordion" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    ...
                    <div className="ColumRight">
                        <div className="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            <div className="panel panel-default" >
                                <div className="panel-heading" role="tab" id="headingOne1">
                                    <h4 className="panel-title">
                                        <a className="btn-accordion"  role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne1" aria-expanded="true" aria-controls="collapseOne1">
                                            <p className="btn-accordion"  >CONTAS A PAGAR E RECEBER</p>
                                        </a>
                                    </h4>
                                </div>
                            <div id="collapseOne1" className="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne1">
                                <div className="panel-body">
                                    Organize e produza relatórios precisos do fluxo de caixa da sua empresa. Controle gastos e investimentos de forma eficiente. Ter uma visão ampla das finanças é um passo importante para um crescimento sustentável.														 </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            <div className="panel panel-default">
                                <div className="panel-heading" role="tab" id="headingTwo1">
                                    <h4 className="panel-title">
                                        <a className="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo1" aria-expanded="false" aria-controls="collapseTwo1">
                                            <p className="btn-accordion" >DIVERSIDADE DE PAGAMENTOS</p>
                                        </a>
                                    </h4>
                                </div>
                                <div id="collapseTwo1" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo1">
                                    <div className="panel-body">
                                    Escolha entre carnês, boletos, cartão de crédito, cheque, dinheiro e débito. Mais diversidade de escolhas para seus clientes.
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="panel-heading" role="tab" id="headingThree1">
                                    <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree1" aria-expanded="false" aria-controls="collapseThree1">
                                            <p class="btn-accordion">SISTEMA INTEGRADO</p>
                                        </a>
                                    </h4>
                                </div>
                                <div id="collapseThree1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree1">
                                    <div class="panel-body">
                                        Tenha um ERP completo em um só programa. Não dependa mais de softwares de terceiros para sua organização empresarial
                                    </div>
                                </div>
                            </div>
                        </div>
